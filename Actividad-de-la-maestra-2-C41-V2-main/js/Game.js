class Game {
  ...
  play() {
    ...
    //PASO 4 Llama a getCarsAtEnd en play() de game.js
    player.getCarsAtEnd();
...
//PASO 7 Crea una condición para finishLine - línea de meta, dentro de play() de game.js
      // Línea de meta
  ...
  handleResetButton() {
    this.resetButton.mousePressed(() => {
      database.ref("/").set({
        ...
        gameState: 0,
        players: {},
        //PASO 6 RESET DE LA BD EN TODOS LOS CAMPOS
        carsAtEnd: 0
      });
      window.location.reload();
    });
  }
//PASO 9 Crea showLife() para mostrar una barra de progreso de combustible en game.js
  showLife() {
    push();
...
//PASO 8 Explica el método showRank() para mostrar la puntuación del jugador usando SWALL() en game.js
/*La función swal() acepta propiedades como Y ES DE SWEET ALERT:
● título:
● texto:
● URL de la imagen:
● tamaño de la imagen:
● Texto del botón de confirmación:  VE AL INDEX 
